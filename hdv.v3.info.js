                ...
                $.ajax({
                    ...
                    success: function (e) {
                        ...
                        if( (typeof e.data.isLogin) != 'undefined'){
                            isLogined = true; // Login
                        }
                        if( (typeof e.data.isVip) != 'undefined'){
                            isHDVip = true; // => become vip
                        }
                        ...
                        if (!isHDVip) {
                            var _tag_preroll = ''; try {_tag_preroll = HadarInstreamAd.getInstreamAdUrl(1054)} catch (e){_tag_preroll = '';}
                            var _tag_preroll_2 = ''; try {_tag_preroll_2 = HadarInstreamAd.getInstreamAdUrl(1057)} catch (e){_tag_preroll_2 = '';}
                        ...
                        jwplayer(HDV.V2.PlayerMedium.name).setup(jConfig);
...
//            } else {
                if (detailConfig.isTrailer) {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        url: 'http://statistic.hdviet.com/api/v1/play',
                        data: {
                            movieId: detailConfig.mid,
                            platform: 1,
                            product: 1,
